...
\newcommand{\diff}{\operatorname{d}} % For upright differential operator
\newcommand{\absder}[2]{\frac{\diff#1}{\diff#2}} % Macro for quick dx/dy (ABSolute DERivative) with upright diff. operator
